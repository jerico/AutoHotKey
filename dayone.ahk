...
dir = J:\Dropbox\DropboxPortableAHK\Dropbox\Journal.dayone\entries\


Gui, Add, Edit, vEntry
Gui, Add, Button, Default, OK
Gui, Show,,Dayone Entry
return
...
GuiClose:
  ButtonOK:
    Gui, Submit
    vUuid := uuid()
    FormatTime, vDate, A_NowUTC, yyyy-MM-ddTHH:mm:ssZ
    template=
    (
...
<dict>
  ...
  <string>%vUuid%</string>
    ...
    FileAppend, %template%, % dir . vUuid . ".doentry"
    ExitApp
